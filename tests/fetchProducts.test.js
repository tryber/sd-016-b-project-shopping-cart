...
describe('1 - Teste a função fecthProducts', () => {
  ...
  it('testa se o retorno da função fetchProducts com o argumento "computador" é uma estrutura de dados igual ao objeto computadorSearch, que já está importado no arquivo', () => {
