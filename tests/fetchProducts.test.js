...
describe('1 - Teste a função fecthProducts', () => {
  ...
  test('2. Teste se fetchProducts com parametro \'computador\' chama fetch', async () => {
    expect.assertions(1);
  ...
  test('4. Teste se fecthProducts com parametro \'computador\'', async () => {
    expect.assertions(1);
    await fetchProducts('computador').then((c) => expect(c).toEqual(computadorSearch));
  });
  
  test('5. Teste se fecthProducts sem parametro retorna um erro', () => expect(() => fetchProducts())
